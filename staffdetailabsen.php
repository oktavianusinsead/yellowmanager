...
{
        $html.="<li>
          <a href='staffinfoabsensi.php?locationid=".$_SESSION['locationid']."&positionid=".$r['positionid']."' class='item-link item-content'>
...
{
            $html.="<li>
          <a href='stafflocationabsensi.php?locationid=".$r['locationid']."' class='item-link item-content'>
            <div class='item-media'>

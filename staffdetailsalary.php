...
{
        $html.="<li>
          <a href='staffinfosalary.php?locationid=".$_SESSION['locationid']."&positionid=".$r['positionid']."' class='item-link item-content'>
...
{
            $html.="<li>
          <a href='stafflocationsalary.php?locationid=".$r['locationid']."' class='item-link item-content'>
            <div class='item-media'>
              <i class='icon icon-stock'></i>
            </div>
            <div class='item-inner'>

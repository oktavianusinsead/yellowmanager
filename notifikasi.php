		...
		<div id='blog-page'>";
		 $login=mysql_query("SELECT p.*,l.fullname FROM sky_messageadmin p
		 	left outer join sky_loginmanager l on l.loginid = p.useradd
                                         ...
                                         WHERE p.locationid='".$_SESSION['locationid']."' and p.approve not in ('x') order by messagedate DESC");
			...
			$html.="<div class='card post-card'>
			  ...
			  <div class='card-content'>
				<div class='card-content-inner'>
				  ...
				  <p>".$r['message']."</p>
				  <p class='color-gray infos'>Status: Approve  -  Comments: 0</p>
				</div> 
			  </div> 
			  <div class='card-footer no-border'>
				<a href='prosesapprove.php?messageid=".$r['messageid']."&userid=".$_SESSION['userid']."' class='button'>Approve</a>
				<a href='notapprove.php' class='button'>Not Approve</a>
				<a href='comment.php' class='button'>Comments</a>
			  </div>
			</div>";
}

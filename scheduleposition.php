  ...
  <div class='content-block-title'>Sales list</div>
    <div class='card'>
      ...
      <div class='card-content-inner'>
        ...
        $login=mysql_query("SELECT * FROM sky_position where positionid in ('11','12','13','14','15','16','17','18','19')
...
{
        $html.="<li>
          <a href='staffshedulelist.php?locationid=".$_GET['locationid']."&positionid=".$r['positionid']."' class='item-link item-content'>

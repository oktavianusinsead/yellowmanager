...
<div class='navbar'>
  <div class='navbar-inner'>
    ...
    <div class='center sliding'>Staff Absensi List</div>
    <div class='right'>
  ...
  <div data-page='toggle' class='page no-toolbar'>
	...
	<div class='content-block-title'>Staff Absensi List</div>
      <div class='content-block'>
                ...
                <div class='card-header'>Klik untuk detail absensi karyawan</div>
				...
				<form method='POST' action='proseswaitinglist.php'>\n
				  ...
				  <ul>
                                  ...
                                  ";
                                        ...
                                        $login=mysql_query("SELECT s.*,p.position FROM sky_staff  s
                                         left outer join sky_position p on p.positionid=s.positionid
                                         WHERE s.locationid='19' order by s.staffname DESC limit 0,10");
...

{
					...
					<li class='accordion-item'><a href='#' class='item-content item-link'>
						<div class='item-inner'>
						  <div class='item-title'>".$r['staffname']." - ".$r['position']."</div>
